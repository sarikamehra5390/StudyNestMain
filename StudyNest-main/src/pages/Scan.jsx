...
const Scan = () => {
  const { logActivity, completeMission } = useUser();
  ...
  const handleScan = () => {
    ...
    setTimeout(() => {
        ...
        setResult({
            ...
            rating: 'High Quality',
            status: 'Good',
            tips: ['Sustainable material', 'Locally sourced']
        });
        
        // Log Activity
        logActivity('scan', 30, 15); // 30 XP, 15 Coins
        completeMission(2); // Try to complete "Scan 1 item" mission
    }, 2000);
  };
  ...
  return (
    <div className="max-w-2xl mx-auto flex flex-col items-center gap-10 pt-10">
        ...
        >
            <h1 className="text-4xl font-bold">Item Scanner</h1>
            <p className="text-muted">Scan products to analyze them.</p>
        </motion.div>
        ...
        <div className="w-full aspect-video glass rounded-3xl relative overflow-hidden flex flex-col items-center justify-center border-2 border-dashed border-white/20 group hover:border-accent/50 transition-colors">
            ...
            {result && !scanning && (
                <div className="flex flex-col items-center gap-4 animate-fade-in">
                    ...
                    <h3 className="text-xl font-bold">Score: Excellent</h3>
